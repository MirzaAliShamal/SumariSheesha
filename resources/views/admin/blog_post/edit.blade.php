...
<div class="col-12">
    <div class="card mt-5">
        ...
        <form action="{{ route('admin.blog.post.save', $list->id) }}" method="POST" class="blogform" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 mb-3" style="margin-left: -12px">
                        <div class="media-body mt-75">
                            <div class="col-12 mt-2">
                                <input type="file" id="account-upload" name="featured_image" data-default-file="{{ asset($list->featured_image) }}" class="dropify">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="blog_category_id" id="category" class="form-control select2">
                                ...
                                @foreach ($categories as $cat )
                                    <option value="{{ $cat->id }}" {{ $list->blog_category_id == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-12">
                        <div class="form-group">
                            <label> Title</label>
                            <input type="text" class="form-control" name="title" id="title" value="{{ $list->title }}" placeholder="Title" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-12">
                        <div class="form-group">
                            <label> Slug</label>
                            <input type="text" class="form-control" name="slug" id="slug" value="{{ $list->slug }}" placeholder="Slug" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea name="body" id="editor" class="form-control" style="height: 300px !important;">{{ $list->body }}</textarea>
                            @error('body')
                    ...
                    <div class="col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="meta_title" id="meta_title" value="{{ $list->meta_title }}" placeholder="Meta Title" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="meta_keywords" id="meta_keywords" value="{{ $list->meta_keywords }}" placeholder="Meta Keywords" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-sm-12 col-12">
                        <div class="form-group">

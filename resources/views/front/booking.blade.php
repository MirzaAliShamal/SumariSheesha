                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="postcode" name="postcode" placeholder="Postcode" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="date" name="date" placeholder="Date" autocomplete="off" value="{{ now()->format('m/d/Y') }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="time">Time</label>
                                <input type="text" class="form-control timepicker" id="timepicker" name="time" placeholder="Time" autocomplete="off" value="{{ now()->format('HH:MM') }}" readonly>
                            </div>
                        </div>
